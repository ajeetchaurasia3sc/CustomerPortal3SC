package com.sssupply.customerportal.jwt;
...
public class JwtUtil {
    ...
    public String generateAccessToken(UserDetails userDetails, String role, String workspaceId) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("role", role);
        if (workspaceId != null) claims.put("workspaceId", workspaceId);
    ...
    public String extractWorkspaceId(String token) { return extractClaim(token, c -> c.get("workspaceId", String.class)); }
}
